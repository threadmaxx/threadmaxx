/// @file test_input_ui_bridge_no_allocations.cpp
/// @brief 100 frames of toUIInput invocation produce zero heap traffic.
...
int main() {
    ...
    if (allocs != 0 || frees != 0) {
        std::fprintf(stderr, "ui_bridge no-alloc gate broke: allocs=%llu frees=%llu\n",
