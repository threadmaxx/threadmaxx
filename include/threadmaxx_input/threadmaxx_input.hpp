...
// Umbrella include for `threadmaxx_input`. Hosts can `#include
// <threadmaxx_input/threadmaxx_input.hpp>` to pull the full public surface,
// or include individual headers à la carte.
